...
@KeepName
public final class Live_Food extends AppCompatActivity
    ...
    private static final String IMAGE_LABEL_DETECTION = "Food Detection";
    ...
    private static final String TAG = "Live Food Class";
